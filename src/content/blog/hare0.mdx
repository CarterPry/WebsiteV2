...
titleUrl: 'https://theumdhare.com/2024/11/20/top-six-jobs-for-cs-majors-after-graduation/'
description: 'A satire features post I wrote for the UMD Hare'
pubDate: 'Nov 20 2024'
heroImage: '../../assets/images/hare0.jpg'
category: '2024'
tags: ["Computer Science", "Satire"]
---

<div style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "27px" }}>
  <p style={{ fontSize: "35px", margin: 0 }}>
    *Product of <a href="https://theumdhare.com/2024/11/20/top-six-jobs-for-cs-majors-after-graduation/" 
    target="_blank" 
    rel="noopener noreferrer" 
    style={{ color: "#A51C30", textDecoration: "none" }}>The UMD Hare</a>*:
  </p>
  <a href="https://theumdhare.com" target="_blank" rel="noopener noreferrer">
    <img
      src="https://theumdhare.com/wp-content/uploads/2023/01/cropped-hare-logo.png?w=240"
      alt="Preview of Top six jobs for CS Majors after Graduation"
...
## 5. Career Fair Recruiter of False Hopes
